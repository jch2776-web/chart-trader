    ...
    <div style={s.modalOverlay} onClick={onClose}>
      <div style={s.modalBox} onClick={e => e.stopPropagation()}>
        ...
        <div style={{
          ...
          ⚠ 손절가(SL)는 거래소 API 제한으로 인해 앱 내부 모니터링으로 처리될 수 있습니다. 브라우저 종료 또는 네트워크 장애 시 작동하지 않을 수 있으므로, 중요한 포지션은 바이낸스 앱에서 직접 설정하시기 바랍니다. 본 서비스는 주문 실패로 인한 손실에 어떠한 책임도 지지 않습니다.
        </div>
